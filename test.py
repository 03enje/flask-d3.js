...
def get_data():
    response1, response2, response3, response4, response5 = run_realtime_report()
    data = {
        "response1": MessageToDict(response1._pb),
        "response2": MessageToDict(response2._pb),
        "response3": MessageToDict(response3._pb),
        "response4": MessageToDict(response4._pb),
        "response5": MessageToDict(response5._pb),
    }
    return jsonify(data)
